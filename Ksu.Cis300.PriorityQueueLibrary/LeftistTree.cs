...
namespace Ksu.Cis300.PriorityQueueLibrary
{
    ...
    {
        /// <summary>
        /// Field is shortest path from the root to an empty subtree
        /// </summary>
        ...
        /// <summary>
        /// Method returns length of shortest path, or 0 if it is the root
        /// </summary>
        /// <param name="t">tree currently looking at</param>
        /// <returns>Shortest path length value stored in tree</returns>
